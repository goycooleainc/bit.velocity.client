 ...
 */
public class ListAuditoryPotencials extends AsyncTask<String, Void, String> {
    ...
    public String directSend(String DATA){
        ...
        String result = "NACK";
        String url = "http://atlas.goycooleainc.enterprises/mobile/audit/item/potencials/list";
        try
        {
