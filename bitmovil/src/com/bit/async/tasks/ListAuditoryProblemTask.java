 ...
 */
public class ListAuditoryProblemTask extends AsyncTask<String, Void, String> {
    ...
    public String directSend(String DATA){
        ...
        String result = "NACK";
        String url = "http://atlas.goycooleainc.enterprises/mobile/audit/item/problem/list";
        try
        {
