...
import com.bit.preferences.BatchLHDSharedPreference;
 ...
 */
public class CreateLhdAuditoryTask extends AsyncTask<String, Integer, String> {
    ...
    public String directSend(){
    	...
    	BatchLHDSharedPreference up = new BatchLHDSharedPreference();
