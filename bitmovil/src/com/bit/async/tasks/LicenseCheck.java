...
//
//public class LicenseCheck extends AsyncTask<String, Void, String>{
//	/**
//	 *
//	 */
...
//     * @return
//     */
//    public String checkLicense(String DATA){
//
//        String result = "NACK";
//        String url = "http://atlas.goycooleainc.enterprises/Workshop/mobile/license";
//        try
//        {
...
//                        result = aux.substring(aux.indexOf("idOrden")).replace("error\":", "").replace("}", "").replace("idOrden\":","").replace("null","").replace("\"","").replace(",","");
//                        String ret = result;
//                    }
//                    else
//                    {
