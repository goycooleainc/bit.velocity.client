...
// */
//public class CreateAuditoryItemTask extends AsyncTask<String, Void, String> {
//
...
//
//        String result = "NACK";
//        String url = "http://atlas.goycooleainc.enterprises/admin/audit/create";
//        try
//        {
...
//            // authentication
//            httpclient.getCredentialsProvider().setCredentials(AuthScope.ANY,new UsernamePasswordCredentials("2-2", "password"));
//
