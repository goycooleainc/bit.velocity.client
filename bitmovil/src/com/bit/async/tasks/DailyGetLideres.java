...
//
public class DailyGetLideres extends AsyncTask<String, Void, String> {
	String usuario;
	String pass;
	String ip;
	String result = null;
	...
	// CAST THE LINEARLAYOUT HOLDING THE MAIN PROGRESS (SPINNER)
	  	LinearLayout linlaHeaderProgress = (LinearLayout) activity.findViewById(R.id.pbHeaderProgress);
	  	 ...
	  	 public DailyGetLideres(Activity activity)
	     {
	...
	{
		//String url = "http://" + ip + "/KomatsuDemoServer/mobile/comboData";
        String url = "http://atlas.goycooleainc.enterprises/mobile/lideres";
		...
		try 
		{
			...
			switch (response.getStatusLine().getStatusCode())
			{
				case 401:
					...
					break;
				case 404:
					result = "No se encontro el servidor";
					break;
				case 200:
