 ...
 */
public class DirectImageDelivery extends AsyncTask<String, Void, String> {
 ...
 // CAST THE LINEARLAYOUT HOLDING THE MAIN PROGRESS (SPINNER)
    ...
    public DirectImageDelivery(Activity activity)
    {
    ...
    public String directSend(String DATA, int pos) throws UnsupportedEncodingException {
        ...
        if(file.exists()){
            ...
            try {
                ...
                ///
                executeMultipartPost(mImage,guid,comments[pos]);
