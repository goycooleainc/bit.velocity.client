...
import com.bit.preferences.BatchADSSharedPreference;
 ...
 */
public class CreateAdsAuditoryTask extends AsyncTask<String, Integer, String> {
    ...
    public String directSend(){
    	...
    	BatchADSSharedPreference up = new BatchADSSharedPreference();
