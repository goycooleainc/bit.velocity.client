...
import com.bit.preferences.BatchTMESharedPreference;
 ...
 */
public class CreateTmeAuditoryTask extends AsyncTask<String, Integer, String> {
    ...
    public String directSend(){
    	...
    	BatchTMESharedPreference up = new BatchTMESharedPreference();
