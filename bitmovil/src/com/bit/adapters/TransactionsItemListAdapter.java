 ...
 *
 */
public class TransactionsItemListAdapter extends BaseAdapter
{
    private final Context _context;
    private List<Transaccion> listData;
    private LayoutInflater layoutInflater;

    public TransactionsItemListAdapter(Context context, List<Transaccion> listData) {
