...
import com.bit.entities.RegistrosParametros;
 ...
 *
 */
public class RegistrosParametrosItemListAdapter extends BaseAdapter
{
    private List<RegistrosParametros> listData;
    private LayoutInflater layoutInflater;

    public RegistrosParametrosItemListAdapter(Context context, List<RegistrosParametros> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String compose = listData.get(position).getAux_one()!=null?listData.get(position).getAux_one():"" + " - " + listData.get(position).getAux_two()!=null?listData.get(position).getAux_two() :"" + " - " + listData.get(position).getAux_three() != null ? listData.get(position).getAux_three() : "";
        ...
        holder.txtOrdenes.setText(compose);
