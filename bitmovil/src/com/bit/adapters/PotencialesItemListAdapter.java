...
import com.bit.entities.Potenciales;
 ...
 *
 */
public class PotencialesItemListAdapter extends BaseAdapter
{
    private List<Potenciales> listData;
    private LayoutInflater layoutInflater;
    
    public PotencialesItemListAdapter(Context context, List<Potenciales> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtOrdenes.setText(listData.get(position).getCausa());
        holder.txtFolio.setText(item);
        holder.txtNumSerie.setText(section);
        holder.txtEstado.setText(listData.get(position).getProblema());
        
        holder.btn_repuestos.setVisibility(View.INVISIBLE);
        holder.btn_camera.setVisibility(View.INVISIBLE);
        holder.btn_problema.setVisibility(View.VISIBLE);
