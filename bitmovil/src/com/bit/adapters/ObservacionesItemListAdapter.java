...
import com.bit.entities.Observaciones;
 ...
 *
 */
public class ObservacionesItemListAdapter extends BaseAdapter
{
    private List<Observaciones> listData;
    private LayoutInflater layoutInflater;
    
    public ObservacionesItemListAdapter(Context context, List<Observaciones> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtOrdenes.setText(listData.get(position).getComentario());
        holder.txtFolio.setText(item);
        holder.txtNumSerie.setText(section);
        holder.txtEstado.setText(listData.get(position).getFoto());
        ...
        holder.btn_obs.setVisibility(View.VISIBLE);
