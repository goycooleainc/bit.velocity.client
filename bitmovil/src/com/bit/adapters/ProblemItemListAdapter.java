...
import com.bit.entities.Problema;
 ...
 *
 */
public class ProblemItemListAdapter extends BaseAdapter
{
    private List<Problema> listData;
    private LayoutInflater layoutInflater;
    
    public ProblemItemListAdapter(Context context, List<Problema> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtOrdenes.setText(listData.get(position).getHecho());
        holder.txtFolio.setText(item);
        holder.txtNumSerie.setText(section);
        holder.txtEstado.setText(listData.get(position).getObservacion());
