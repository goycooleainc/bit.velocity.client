...
import com.goycooleainc.items.Passport;
import com.goycooleainc.ui.base.PurchaseActivity;

/**
 * This activity will purchase a Passport from Google Play.
 * 
 * If you wanted to change to purchase something else all you have to change is the SKU_M (item id) that is used
...
public class PurchasePassportActivity extends PurchaseActivity {
    ...
    protected void dealWithIabSetupSuccess() {
        ...
        producto = VendingSingleton.getInstance().producto;

            String sku = producto !=null ? producto.getCodigo() : Passport.SKU_M;
            purchaseItem(sku);
